...
import { end, begin } from '@ember/runloop';
import getScroll from '../utils/get-scroll.js';
...
class ScrollActivityService extends FastBootAwareEventManagerService {
  constructor() {
    super(...arguments);
...
export { ScrollActivityService as default };
//# sourceMappingURL=scroll-activity.js.map
